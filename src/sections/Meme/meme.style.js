  ...
  .meme-group {
    ...
    .meme-content {
      ...
      button {
        ...
        z-index: 1;
        box-shadow: -0.5em 0.5em transparentize(${slate_color}, 1);
        ...
        &:hover {
          ...
          box-shadow: -1em 1em 0.15em transparentize(${slate_color}, 0.9);
          ...
          &:after {
            background-image: (
              linear-gradient(45deg, ${blue_color} 0%, ${pink_color} 100%)
            );
    ...
    button.meme-btn {
      ...
      border-image: linear-gradient(
        45deg,
        lighten(${blue_color}, 20%) 0%,
        lighten(${pink_color}, 20%) 100%
      );
      border-image-slice: 1;
      color: white;
