    ...
    <OurTeamWrapper className="section" id="ourteam">
      ...
      <Container>
        <Box className="ourteam-heading">
          ...
          <Text className="hide">
            Behind a great game stand the passionate and talented people in the
            industry.
            <br />
            We want to bring the best experience to all the players.
          </Text>
          <Text className="screen">
            Behind a great game stand the passionate and talented people in the
            industry. We want to bring the best experience to all the players.
          </Text>
        </Box>
