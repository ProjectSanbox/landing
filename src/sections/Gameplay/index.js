    ...
    <GamePlayWrapper className="section" id="gameplay">
      <Container>
        <Box className="gameplay-heading">
          ...
          <Text className="hide">
            Planet Sandbox is a virtual world where players can play, build,
            own, and
            <br />
            monetize their virtual experiences. We empower artists, creators,
            and players
            <br />
            to build the platform they always envisioned, providing the means to
            unleash
            <br />
            your creativity.{" "}
          </Text>
          <Text className="screen">
            Planet Sandbox is a virtual world where players can play, build,
            own, and monetize their virtual experiences. We empower artists,
